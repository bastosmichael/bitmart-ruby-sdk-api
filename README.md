...
- Supports Spot, Contract, Account, and System API modules
...
### 0.1.3 (2023-07-05)
- Added Contract API module
- Added Account API module
- Improved error handling and documentation
- Updated installation instructions for Ruby 2.3.0+
